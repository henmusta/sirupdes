...
<head>
        ...
        <link rel="stylesheet" href="{{asset('assets/frontend/css/mediaelementplayer.css')}}">
        <link rel="stylesheet" href="{{asset('assets/frontend/css/style.css')}}">
        <link rel="stylesheet" href="{{asset('assets/frontend/css/revslider/revslider-index9.css')}}">
        <link rel="stylesheet" id="color-scheme" href="{{asset('assets/frontend/css/colors/green.css')}}">
        ...
        <!-- Queryloader -->
        <script src="{{asset('assets/frontend/js/queryloader2.min.js')}}"></script>
    ...
    <div class="preview-panel">
        <div class="preview-panel-wrapper">
            <a href="#" id="preview-panel-btn" title="Toggle Panel">
            ...
            <div id="preview-panel-carousel" class="carousel slide" data-ride="carousel" data-interval="false">
                <ol class="carousel-indicators">
                    <li data-target="#preview-panel-carousel" data-slide-to="0" class="active">
                        <i class="fa fa-paint-brush"></i>Color
                    </li>
                    <li data-target="#preview-panel-carousel" data-slide-to="1">
                        <i class="fa fa-exchange"></i>Layout
                    </li>
                    <li data-target="#preview-panel-carousel" data-slide-to="2">
                        <i class="fa fa-photo"></i>Pattern
                    </li>
                </ol>
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <div class="preview-panel-section">
                            <div class="row">
                                <span class="preview-color-box" title="green.css" style="background:#009688" data-stylesheet="green.html"></span>
                                <span class="preview-color-box" title="green2.css" style="background:#27967A" data-stylesheet="green2.html"></span>
                                <span class="preview-color-box" title="seagreen.css" style="background:#6EADA8" data-stylesheet="seagreen.html"></span>
                                <span class="preview-color-box" title="violetred.css" style="background:#AB5156" data-stylesheet="violetred.html"></span>
                                <span class="preview-color-box" title="purple.css" style="background:#996794" data-stylesheet="purple.html"></span>
                                <span class="preview-color-box" title="gold.css" style="background:#B8AC5A" data-stylesheet="gold.html"></span>
                                <span class="preview-color-box" title="lightblue.css" style="background:#009AA8" data-stylesheet="lightblue.html"></span>
                                <span class="preview-color-box" title="blue.css" style="background:#1B778C" data-stylesheet="blue.html"></span>
                                <span class="preview-color-box" title="darkblue.css" style="background:#244C8D" data-stylesheet="darkblue.html"></span>
                                <span class="preview-color-box" title="salmon.css" style="background:#968783" data-stylesheet="salmon.html"></span>
                                <span class="preview-color-box" title="brown.css" style="background:#7D7F66" data-stylesheet="brown.html"></span>
                                <span class="preview-color-box" title="brown2.css" style="background:#BF8D30" data-stylesheet="brown2.html"></span>
                            </div><!-- End .row -->
                        </div><!-- End .preview-panel-section -->
                    </div><!-- end .item -->
                    <div class="item">
                        <div class="preview-panel-section">
                            <p class="preview-panel-desc">Not recommended to use boxed or boxed-long layout with side-menu pages.</p>
                            <div class="row">
                                <span class="preview-layout-box" data-layout="fullwidth">Fullwidth</span>
                                <span class="preview-layout-box" data-layout="boxed">Boxed</span>
                                <span class="preview-layout-box" data-layout="boxed-long">Boxed Long</span>
                            </div><!-- End .row -->
                        </div><!-- End .preview-panel-section -->
                    </div><!-- end .item -->
                    <div class="item">
                        <div class="preview-panel-section">
                            <p class="preview-panel-desc">To see the changes you need to change layout to boxed or boxed-long.</p>
                            <div class="row">
                                <span class="preview-pattern-box pattern1" data-pattern="pattern1"></span>
                                <span class="preview-pattern-box pattern2" data-pattern="pattern2"></span>
                                <span class="preview-pattern-box pattern3" data-pattern="pattern3"></span>
                                <span class="preview-pattern-box pattern4" data-pattern="pattern4"></span>
                                <span class="preview-pattern-box pattern5" data-pattern="pattern5"></span>
                                <span class="preview-pattern-box pattern6" data-pattern="pattern6"></span>
                                <span class="preview-pattern-box pattern7" data-pattern="pattern7"></span>
                                <span class="preview-pattern-box pattern8" data-pattern="pattern8"></span>
                                <span class="preview-pattern-box pattern9" data-pattern="pattern9"></span>
                                <span class="preview-pattern-box pattern10" data-pattern="pattern10"></span>
                                <span class="preview-pattern-box pattern11" data-pattern="pattern11"></span>
                                <span class="preview-pattern-box pattern12" data-pattern="pattern12"></span>
                                <span class="preview-pattern-box pattern13" data-pattern="pattern13"></span>
                                <span class="preview-pattern-box pattern14" data-pattern="pattern14"></span>
                                <span class="preview-pattern-box pattern15" data-pattern="pattern15"></span>
                                <span class="preview-pattern-box pattern16" data-pattern="pattern16"></span>
                                <span class="preview-pattern-box pattern17" data-pattern="pattern17"></span>
                                <span class="preview-pattern-box pattern18" data-pattern="pattern18"></span>
                                <span class="preview-pattern-box pattern19" data-pattern="pattern19"></span>
                                <span class="preview-pattern-box pattern20" data-pattern="pattern20"></span>
                                <span class="preview-pattern-box pattern21" data-pattern="pattern21"></span>
                                <span class="preview-pattern-box pattern22" data-pattern="pattern22"></span>
                                <span class="preview-pattern-box pattern23" data-pattern="pattern23"></span>
                                <span class="preview-pattern-box pattern24" data-pattern="pattern24"></span>
                                <span class="preview-pattern-box pattern25" data-pattern="pattern25"></span>
                                <span class="preview-pattern-box pattern26" data-pattern="pattern26"></span>
                                <span class="preview-pattern-box pattern27" data-pattern="pattern27"></span>
                                <span class="preview-pattern-box pattern28" data-pattern="pattern28"></span>
                                <span class="preview-pattern-box pattern29" data-pattern="pattern29"></span>
                                <span class="preview-pattern-box pattern30" data-pattern="pattern30"></span>
                            </div><!-- End .row -->
                        </div><!-- End .preview-panel-section -->
                    </div><!-- end .item -->
                </div><!-- End .carousel-inner -->
                <a href="#" class="btn btn-dark btn-block no-radius" id="preview-reset-btn" title="Reset">Reset All</a>
            </div><!-- End #preview-panel-carousel -->
        </div><!-- End .preview-panel-wrapper -->
    ...
    <div id="wrapper">
                    ...
                    <div class="container">
                        <div class="pull-left">
                            <ul class="navbar-top-nav clearfix hidden-sm hidden-xs">
                                ...
                                <li><a href="login.html"><i class="fa fa-external-link"></i>Login</a></li>
                                <li><a href="register.html"><i class="fa fa-terminal"></i>Register</a></li>
                        ...
                        <div class="pull-right">
                            <div class="dropdowns-container pull-right last clearfix">
                            ...
                            <div class="navbar-header fullwidth">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 clearfix">
                                        ...
                                        <div class="dropdown cart-dropdown pull-right visible-xs">
                                            <button type="button" class="navbar-btn btn-icon dropdown-toggle" data-toggle="dropdown"><i class="fa fa-shopping-cart"></i></button>
                                        ...
                                        <a class="navbar-brand navbar-brand-center bordered text-uppercase" href="index.html" title="Boss - Multipurpose Premium Html5 Template">Boss</a>
                                    </div><!-- End .col-sm-4 -->
                                    <div class="col-sm-4 hidden-xs">
                                    ...
                                    <div class="row">
                                        <div class="container">
                                            <ul class="nav navbar-nav">
                                                ...
                                                <li class="visible-lg"><a href="http://wrapbootstrap.com/user/eony">Buy Now!</a></li>
                                            </ul>
                                        </div><!-- End container -->
                                    </div><!-- End row -->
                                </div><!-- /.navbar-collapse -->
        ...
        <div id="content" role="main" class="no-padding">
            <div id="revslider-container">
                <div id="revslider">
                    <ul>
                        <li data-transition="fade" data-slotamount="8" data-masterspeed="800" data-title="Boss of All Templates" data-thumb="images/homesliders/index9/slide1.jpg">
                            <!-- background image -->
                            <img src="images/revslider/dummy.png"  alt="slidebg1" data-lazyload="images/homesliders/index9/slide1.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                            ...
                            <div class="tp-caption rev-subtitle lfb ltt"
                                ...
                                data-endspeed="400"
                                style="z-index: 10">This the template you need
                            </div>
                            ...
                            <div class="tp-caption rev-title lfb ltt"
                                ...
                                data-easing="Power3.easeInOut"
                                data-endspeed="600"
                                style="z-index: 6"><strong>Boss</strong> of <strong>All</strong> Templates
                            </div>
                            ...
                            <div class="tp-caption rev-btn lfb ltt"
                                ...
                                data-endspeed="800"
                                style="z-index: 14">
                                    <a href="#" class="btn btn-white no-radius min-width">See Features!</a>
                                    <a href="#" class="btn btn-dark no-radius min-width">Purchase Now!</a>
                            </div>
                        </li>
                        <li data-transition="fade" data-slotamount="8" data-masterspeed="800" data-title="Multipurpose Template" data-thumb="images/homesliders/index9/slide2.jpg">
                            <!-- background image -->
                            <img src="images/revslider/dummy.png"  alt="slidebg1" data-lazyload="images/homesliders/index9/slide2.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                            ...
                            <div class="tp-caption rev-subtitle lfb ltt"
                                ...
                                data-easing="Power3.easeInOut"
                                data-endspeed="400"
                                style="z-index: 10">Multipurpose Template
                            </div>
                            ...
                            <div class="tp-caption rev-title lfb ltt"
                                ...
                                data-easing="Power3.easeInOut"
                                data-endspeed="600"
                                style="z-index: 6"><strong>Boss</strong> is <strong>all</strong> you need
                            </div>
            ...
            <div class="container">
                <h2 class="title-border gray title-bg text-center mb40"><span>What we Offer?</span></h2>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="service vertical text-center">

                            <span class="service-icon"><i class="icon-umbrella"></i></span>
                            <div class="service-content">
                                <h3 class="service-title title-underblock custom text-uppercase text-center">Hundreds of Features</h3>
                    ...
                    <div class="col-sm-4">
                        <div class="service vertical text-center">
                            ...
                            <span class="service-icon"><i class="icon-anchor"></i></span>
                            <div class="service-content">
                                <h3 class="service-title title-underblock custom text-uppercase text-center">Bootstrap Based</h3>

                                <p>Harum repellat quaerat accusantium fuga aliquam dolorum, tempora recusandae minus quibusdam laborum dolor emque susc ipit nisi excepturi, nemo ut, dolorem sit.</p>
                            </div><!-- End .service-content -->
                    ...
                    <div class="col-sm-4">
                        <div class="service vertical text-center">
                            ...
                            <span class="service-icon"><i class="icon-doc"></i></span>
                            <div class="service-content">
                                <h3 class="service-title title-underblock custom text-uppercase text-center">200+ Html Pages</h3>

                                <p>Reiciendis, ad a fugit quas! Ratione praesentium alias pariatur repellat voluptates, nemo quos officia! Similique itaque odio laudantium delectus quibusdam sie.</p>
                            </div><!-- End .service-content -->
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="service vertical text-center">
                            ...
                            <span class="service-icon"><i class="icon-magic-wand"></i></span>
                            <div class="service-content">
                                <h3 class="service-title title-underblock custom text-uppercase text-center">Designed with Love</h3>
                    ...
                    <div class="col-sm-4">
                        <div class="service vertical text-center">
                            ...
                            <span class="service-icon"><i class="icon-doc"></i></span>
                            <div class="service-content">
                                <h3 class="service-title title-underblock custom text-uppercase text-center">40+ Homepages</h3>
                    ...
                    <div class="col-sm-4">
                        <div class="service vertical text-center">
                            ...
                            <span class="service-icon"><i class="icon-trophy"></i></span>
                            <div class="service-content">
                                <h3 class="service-title title-underblock custom text-uppercase text-center">Valid &amp; Clean Coded</h3>
            ...
            <div class="callout no-border larger no-margin">
                <div class="container">
                    <div class="callout-wrapper">
                        <div class="callout-left">
                            <h2 class="callout-title">All you need is boss! Purchase now and enjoy the awesomeness.</h2>
                            <p class="callout-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam eos iste assumenda dolor veritatis ducimus nostrum?</p>
                        </div><!-- End .callout-left -->
                        <div class="callout-right">
                            <a href="#" class="btn btn-dark no-radius min-width">Buy Now!</a>
            ...
            <div class="mb80"></div><!-- space -->
                ...
                <div class="container">
                    <h2 class="title-border gray title-bg text-center mb40"><span>Meet the Team</span></h2>

                    <div class="owl-carousel team-carousel-index9 center-nav center-nav-animate white-nav no-radius">
                        <div class="team-member boxed-member team-animate-social text-center">
                            <figure>
                                <img src="images/team/david.jpg" alt="David" class="img-responsive">
                                <figcaption>
                                    <div class="social-icons text-center">
                                        <a href="#" class="social-icon icon-facebook add-tooltip" title="" data-original-title="Facebook">
                                            <i class="fa fa-facebook"></i>
                                        </a>
                                        <a href="#" class="social-icon icon-twitter add-tooltip" title="" data-original-title="Twitter">
                                            <i class="fa fa-twitter"></i>
                                        </a>
                                        <a href="#" class="social-icon icon-google-plus add-tooltip" title="" data-original-title="Google Plus">
                                            <i class="fa fa-google-plus"></i>
                                        </a>
                                        <a href="#" class="social-icon icon-skype add-tooltip" title="" data-original-title="Skype">
                                            <i class="fa fa-skype"></i>
                                        </a>
                                        <a href="#" class="social-icon icon-linkedin add-tooltip" title="" data-original-title="Linkedin">
                            ...
                            <h3>David O'neil</h3>
                            <p class="member-desc">Ceo - <span>(Director)</span></p>
                        </div><!-- End .team-member -->

                        <div class="team-member boxed-member team-animate-social text-center">
                            <figure>
                                <img src="images/team/jessica.jpg" alt="Jessica" class="img-responsive">
                                <figcaption>
                                    <div class="social-icons text-center">
                                        <a href="#" class="social-icon icon-facebook add-tooltip" title="" data-original-title="Facebook">
                                            <i class="fa fa-facebook"></i>
                            ...
                            <h3>Jessica Barber.</h3>
                            <p class="member-desc">Designer - <span>(Senior)</span></p>
                        </div><!-- End .team-member -->

                        <div class="team-member boxed-member team-animate-social text-center">
                            <figure>
                                <img src="images/team/steve.jpg" alt="Steve" class="img-responsive">
                                <figcaption>
                                    <div class="social-icons text-center">
                                        <a href="#" class="social-icon icon-facebook add-tooltip" title="" data-original-title="Facebook">
                                            <i class="fa fa-facebook"></i>
                            ...
                            <h3>Steve Ellie Jr.</h3>
                            <p class="member-desc">Designer - <span>(Junior)</span></p>
                        </div><!-- End .team-member -->

                        <div class="team-member boxed-member team-animate-social text-center">
                            <figure>
                                <img src="images/team/sarah.jpg" alt="Sarah" class="img-responsive">
                                <figcaption>
                                    <div class="social-icons text-center">
                                        <a href="#" class="social-icon icon-facebook add-tooltip" title="" data-original-title="Facebook">
                                            <i class="fa fa-facebook"></i>
                            ...
                            <h3>Sarah Jessica Samso</h3>
                            <p class="member-desc">Developer - <span>(Senior)</span></p>
                        </div><!-- End .team-member -->

                        <div class="team-member boxed-member team-animate-social text-center">
                            <figure>
                                <img src="images/team/barbara.jpg" alt="Barbara" class="img-responsive">
                                <figcaption>
                                    <div class="social-icons text-center">
                                        <a href="#" class="social-icon icon-facebook add-tooltip" title="" data-original-title="Facebook">
                                            <i class="fa fa-facebook"></i>
                            ...
                            <h3>Barbara Jessica </h3>
                            <p class="member-desc">Designer - <span>(Senior)</span></p>
                        </div><!-- End .team-member -->

                        <div class="team-member boxed-member team-animate-social text-center">
                            <figure>
                                <img src="images/team/eric.jpg" alt="Eric" class="img-responsive">
                                <figcaption>
                                    <div class="social-icons text-center">
                                        <a href="#" class="social-icon icon-facebook add-tooltip" title="" data-original-title="Facebook">
                                            <i class="fa fa-facebook"></i>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="title-underblock dark mb40">Fun at the Office</h2>
                            <h5 class="lead">We are a fun team who enjoy working together and spend time at office. Come and join our office..</h5>
                            <p>Proin fringilla dui eget efficitur interdum. Donec ac libero urna. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas rutrum pellentesque sapien, id placerat velit mollis a. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis vel efficitur libero.</p>
                            <p>Sed et malesuada ex. Pellentesque rhoncus elit augue, ac ullamcorper nulla scelerisque sed. Sed commodo dapibus sagittis. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
                            <p>In et venenatis nisl, nec tincidunt augue. Nam id efficitur orci, a viverra nisi. Suspendisse molestie tortor at fringilla molestie. Proin laoreet, tortor nec semper viverra, magna erat finibus ante, sed facilisis arcu orci feugiat erat. Pellentesque aliquet neque non diam congue, vel pellentesque nunc pharetra. Quisque tempus ultrices dui a ultrices. Integer euismod pharetra metus ut tincidunt.</p>
                        </div><!-- End .col-md-6 -->

                        <div class="col-md-6">
                            <div class="mb30"></div><!-- space -->
                            <div class="owl-carousel aboutus-slider">
                                <img src="images/aboutus-slide1.jpg" alt="Aboutus slide 1">
                                <img src="images/aboutus-slide2.jpg" alt="Aboutus slide 2">
                                <img src="images/aboutus-slide3.jpg" alt="Aboutus slide 3">
                            </div><!-- End .owl-carousel -->
                        </div><!-- End .col-md-6 -->
                    </div><!-- End .row -->
                </div><!-- End .container -->

            <div class="mb60 mb70-xs"></div><!-- space -->

            <div class="bg-image"  data-bgattach="images/backgrounds/index9/bg3.jpg">
                <div class="container">
                    <div class="mb70"></div><!-- space -->
                    <h2 class="title-underblock dark text-center mb60">Passion Meets Skills</h2>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="circle-progress-container">
                                ...
                                <div class="circle-progress progress-animate">
                                    <input type="text" class="knob" data-width="150"  data-height="150" data-readOnly="true" data-fgColor="#009688" data-animateto="92" data-thickness=".1">
                                </div><!-- End .circle-progress -->

                                <h4 class="progress-title">Web Design</h4>

                            </div><!-- End .circle-progress-container -->
                        </div><!-- End .col-md-3 -->
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="circle-progress-container">
                                ...
                                <div class="circle-progress progress-animate">
                                    <input type="text" class="knob" data-width="150"  data-height="150" data-readOnly="true" data-fgColor="#009688" data-animateto="87" data-thickness=".1">
                                </div><!-- End .circle-progress -->

                                <h4 class="progress-title">Logo Design</h4>

                            </div><!-- End .circle-progress-container -->
                        </div><!-- End .col-md-3 -->

                        <div class="mb30 visible-sm clearfix"></div><!-- space -->

                        <div class="col-md-3 col-sm-6">
                            <div class="circle-progress-container">

                                <div class="circle-progress progress-animate">
                                    <input type="text" class="knob" data-width="150"  data-height="150" data-readOnly="true" data-fgColor="#009688" data-animateto="72" data-thickness=".1">
                                </div><!-- End .circle-progress -->

                                <h4 class="progress-title">Seo Expertise</h4>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="circle-progress-container">
                                ...
                                <div class="circle-progress progress-animate">
                                    <input type="text" class="knob" data-width="150"  data-height="150" data-readOnly="true" data-fgColor="#009688" data-animateto="89" data-thickness=".1">
                                </div><!-- End .circle-progress -->

                                <h4 class="progress-title">Support</h4>
            ...
            <div class="container">
                <h2 class="title-border gray title-bg text-center mb40"><span>Checkout Portfolio</span></h2>

                <ul id="portfolio-filter" class="bordered text-center">
                ...
                <div id="portfolio-item-container" class="graybg max-col-4 popup-gallery" data-layoutmode="fitRows">
                    <div class="portfolio-item portfolio-meta-slidedown push design">
                        <figure>
                            <a href="images/portfolio/aboutme/item2.jpg" class="zoom-item" title="Portfolio Item Description"><img src="images/portfolio/aboutme/item2.jpg" alt="portfolio item name" class="img-responsive"></a>
                        </figure>
                        <div class="portfolio-meta">
                            <h3 class="portfolio-title"><a href="single-portfolio.html">Cool Buggy</a></h3>
                            <div class="portfolio-tags"><a href="#">Design</a>, <a href="#">Love</a></div>
                    ...
                    <div class="portfolio-item portfolio-meta-slidedown push fashion">
                        <figure>
                            <a href="images/portfolio/aboutme/item12.jpg" class="zoom-item" title="Portfolio Item Description"><img src="images/portfolio/aboutme/item12.jpg" alt="portfolio item name" class="img-responsive"></a>
                        </figure>
                        <div class="portfolio-meta">
                            <h3 class="portfolio-title"><a href="single-portfolio.html">Cool Buggy</a></h3>
                            <div class="portfolio-tags"><a href="#">Design</a>, <a href="#">Love</a></div>
                    ...
                    <div class="portfolio-item portfolio-meta-slidedown push">
                        <figure>
                            <a href="images/portfolio/aboutme/item4.jpg" class="zoom-item" title="Portfolio Item Description"><img src="images/portfolio/aboutme/item4.jpg" alt="portfolio item name" class="img-responsive"></a>
                        </figure>
                        <div class="portfolio-meta">
                            <h3 class="portfolio-title"><a href="single-portfolio.html">Cool Buggy</a></h3>
                            <div class="portfolio-tags"><a href="#">Design</a>, <a href="#">Love</a></div>
                    ...
                    <div class="portfolio-item portfolio-meta-slidedown push illustration">
                        <figure>
                            <a href="images/portfolio/aboutme/item1.jpg" class="zoom-item" title="Portfolio Item Description"><img src="images/portfolio/aboutme/item1.jpg" alt="portfolio item name" class="img-responsive"></a>
                        </figure>
                        <div class="portfolio-meta">
                            <h3 class="portfolio-title"><a href="single-portfolio.html">Cool Buggy</a></h3>
                            <div class="portfolio-tags"><a href="#">Design</a>, <a href="#">Love</a></div>
                    ...
                    <div class="portfolio-item portfolio-meta-slidedown push fashion video">
                        <figure>
                            <a href="images/portfolio/aboutme/item7.jpg" class="zoom-item" title="Portfolio Item Description"><img src="images/portfolio/aboutme/item7.jpg" alt="portfolio item name" class="img-responsive"></a>
                        </figure>
                        <div class="portfolio-meta">
                            <h3 class="portfolio-title"><a href="single-portfolio.html">Cool Buggy</a></h3>
                            <div class="portfolio-tags"><a href="#">Design</a>, <a href="#">Love</a></div>
                    ...
                    <div class="portfolio-item portfolio-meta-slidedown push photography">
                        <figure>
                            <a href="images/portfolio/aboutme/item6.jpg" class="zoom-item" title="Portfolio Item Description"><img src="images/portfolio/aboutme/item6.jpg" alt="portfolio item name" class="img-responsive"></a>
                        </figure>
                        <div class="portfolio-meta">
                            <h3 class="portfolio-title"><a href="single-portfolio.html">Cool Buggy</a></h3>
                            <div class="portfolio-tags"><a href="#">Design</a>, <a href="#">Love</a></div>
                    ...
                    <div class="portfolio-item portfolio-meta-slidedown push design video">
                        <figure>
                            <a href="images/portfolio/aboutme/item10.jpg" class="zoom-item" title="Portfolio Item Description"><img src="images/portfolio/aboutme/item10.jpg" alt="portfolio item name" class="img-responsive"></a>
                        </figure>
                        <div class="portfolio-meta">
                            <h3 class="portfolio-title"><a href="single-portfolio.html">Cool Buggy</a></h3>
                            <div class="portfolio-tags"><a href="#">Design</a>, <a href="#">Love</a></div>
                    ...
                    <div class="portfolio-item portfolio-meta-slidedown push video photography">
                        <figure>
                            <a href="images/portfolio/aboutme/item8.jpg" class="zoom-item" title="Portfolio Item Description"><img src="images/portfolio/aboutme/item8.jpg" alt="portfolio item name" class="img-responsive"></a>
                        </figure>
                        <div class="portfolio-meta">
                            <h3 class="portfolio-title"><a href="single-portfolio.html">Cool Buggy</a></h3>
                            <div class="portfolio-tags"><a href="#">Design</a>, <a href="#">Love</a></div>
            ...
            <div class="mb10 mb40-xs"></div><!-- space -->

            <div class="bg-image"  data-bgattach="images/backgrounds/index9/bg2.jpg">
                <div class="container">
                    <div class="mb70"></div><!-- space -->
                    <h2 class="title-underblock dark text-center mb60">Testimonials and Partners</h2>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="owl-carousel testimonial-slider">
                            <div class="testimonial border-dark">
                                <figure>
                                    <img src="images/testimonials/dean.jpg" alt="Dean">
                                </figure>
                                <div class="testimonial-content">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias velit doloremque eaque ea optio, incidunt, sint maiores omnis, cumque et illum deserunt repellat laudantium, natus iusto architecto aliquid dicta sapiente.Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                                    <h5>Dean Sam Winchester - <a href="#" title="Nike Company">Nike Design.</a></h5>
                            ...
                            <div class="testimonial border-dark">
                                ...
                                <div class="testimonial-content">
                                    ...
                                    <h5><a href="#" title="Nike Company">Nike Design.</a> - John Jess Jhonson</h5>
                                </div><!-- End .testimonial-content -->
                            </div><!-- End .testimonial -->
                            <div class="testimonial border-dark">
                                <figure>
                        ...
                        <div class="col-md-6">
                            <div class="owl-carousel our-clients-smaller">
                    ...
                    <div class="mb30 mb50-sm"></div><!-- space -->
                </div><!-- End .container -->

            </div><!-- End .testi and partners -->

            <div class="mb80"></div><!-- space -->

            <div class="container">
                <h2 class="title-border gray title-bg text-center mb40"><span>Latest Posts</span></h2>
                <div class="max-col-4" id="blog-item-container">
                    <article class="entry entry-box wow zoomIn">

                        <div class="entry-media">
                            <figure>
                                <a href="single.html">
                                    <img src="images/blog/post1.jpg" alt="Entry Title">
                                </a>
                            </figure>
                        </div><!-- End .entry-media -->
                        ...
                        <div class="entry-content-wrapper">
                            ...
                            <h2 class="entry-title"><a href="single.html">Ipsa quasi praesentium eos officiis nam molestiae facere.</a></h2>


                            <div class="entry-content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec interdum condimentum erat, quis imperdiet dolor maximus nec. Etiam felis erat, suscipit in ante ut, tincidunt tempor justo.</p>
                            </div><!-- End .entry-content -->
                        </div><!-- End .entry-content-wrapper -->

                        <footer class="entry-footer clearfix">
                            <span class="entry-cats">
                                <span class="entry-label"><i class="fa fa-tag"></i></span><a href="#">Life</a>, <a href="#">Design</a>
                            </span><!-- End .entry-tags -->
                            <span class="entry-separator">/</span>
                            <a href="#" class="entry-comments">10 <i class="fa fa-comments"></i></a>
                            <span class="entry-separator">/</span>
                            by <a href="#" class="entry-author">Eon</a>

                        </footer>

                    </article>

                    <article class="entry entry-box entry-box-blockquote wow zoomIn" data-wow-delay="0.15s">

                        <div class="entry-content entry-blockquote">
                            <blockquote>
                                <p>Mauris urna dolor, fringilla in vestibulum sed, porta sit amet nibh. Mauris consectetur neque quis arcu pellentesque porttitor. Aenean in diam ligula..</p>
                    ...
                    <article class="entry entry-box wow zoomIn" data-wow-delay="0.3s">
                        ...
                        <div id="post-id-1" class="entry-media carousel slide" data-ride="carousel" data-interval="7000">
                            <div class="entry-media carousel-inner">
                                <div class="item active">
                                    <a href="single.html"><img src="images/blog/post3.jpg" class="img-responsive" alt="Slider post 1"></a>
                                </div><!-- End .item -->

                                <div class="item">
                                    <a href="single.html"><img src="images/blog/post2.jpg" class="img-responsive" alt="Slider post 2"></a>
                                </div><!-- End .item -->

                                <div class="item">
                                    <a href="single.html"><img src="images/blog/post1.jpg" class="img-responsive" alt="Slider post 3"></a>
                                </div><!-- End .item -->
                            </div><!-- End .carousel-inner -->

                            <!-- Controls -->
                            <a class="left carousel-control" href="#post-id-1" role="button" data-slide="prev"><i class="fa fa-angle-left"></i></a>
                            <a class="right carousel-control" href="#post-id-1" role="button" data-slide="next"><i class="fa fa-angle-right"></i></a>
                        </div><!-- End .entry-media -->
                        ...
                        <div class="entry-content-wrapper">
                            ...
                            <h2 class="entry-title"><a href="single.html">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a></h2>

                            <div class="entry-content">
                                <p>Etiam felis erat, suscipit in ante ut, tincidunt tempor justo. In ut odio at est luctus tempor. Quisque vehicula nisl ex, posuere sollicitudin ante vulputate et.</p>
                            </div><!-- End .entry-content -->
                        </div><!-- End .entry-content-wrapper -->

                        <footer class="entry-footer clearfix">
                            <span class="entry-cats">
                                <span class="entry-label"><i class="fa fa-tag"></i></span><a href="#">Gallery</a>
                            </span><!-- End .entry-tags -->
                            <span class="entry-separator">/</span>
                            <a href="#" class="entry-comments">4 <i class="fa fa-comments"></i></a>
                            <span class="entry-separator">/</span>
                    ...
                    <article class="entry entry-box wow zoomIn" data-wow-delay="0.45s">

                        <div class="entry-media">
                            <figure>
                                <a href="single.html">
                                    <img src="images/blog/post4.jpg" alt="Entry Title">
                                </a>
                            </figure>
                        </div><!-- End .entry-media -->
                        ...
                        <div class="entry-content-wrapper">
                            ...
                            <h2 class="entry-title"><a href="single.html">Consec tetur adipi scing elit nam molestiae facere.</a></h2>
                        ...
                        <footer class="entry-footer clearfix">
                            <span class="entry-cats">
                                <span class="entry-label"><i class="fa fa-tag"></i></span><a href="#">Design</a>
                            </span><!-- End .entry-tags -->
                            <span class="entry-separator">/</span>
                            <a href="#" class="entry-comments">4 <i class="fa fa-comments"></i></a>
                            <span class="entry-separator">/</span>
                    ...
                    <article class="entry entry-box wow zoomIn" data-wow-delay="0.6s">

                        <div class="entry-media embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="http://player.vimeo.com/video/30173582?color=ffffff" width="500" height="281" allowfullscreen></iframe>
                        </div><!-- End .entry-media -->

                        <div class="entry-content-wrapper">
                            <span class="entry-date">5<span>Feb</span></span>
                            <span class="entry-format"><i class="fa fa-file-video-o"></i></span>

                            <h2 class="entry-title"><a href="single.html">Cras tempor, eros sit amet fringilla lacinia, nisi enim bibendum dui.</a></h2>


                            <div class="entry-content">
                                <p>Integer cursus sodales hendrerit. Sed tempor augue tellus, non ullamcorper enim ullamcorper sit amet. Nullam ut mattis justo. Nulla et purus pulvinar varius purus non.</p>
                            </div><!-- End .entry-content -->
                        </div><!-- End .entry-content-wrapper -->
                        ...
                        <footer class="entry-footer clearfix">
                            ...
                            <span class="entry-separator">/</span>
                            <a href="#" class="entry-comments">2 <i class="fa fa-comments"></i></a>
                            <span class="entry-separator">/</span>
                            by <a href="#" class="entry-author">admin</a>
                    ...
                    <article class="entry entry-box entry-box-blockquote wow zoomIn">

                        <div class="entry-content entry-blockquote">
                            <blockquote>
                                <p>Proin a mi posuere, scelerisque arcu et, auctor massa. Nulla vulputate nibh id orci lobortis mattis.</p>
                    ...
                    <article class="entry entry-box wow zoomIn" data-wow-delay="0.75s">

                        <div class="entry-media">
                            <figure>
                                <a href="single.html">
                                    <img src="images/blog/post5.jpg" alt="Entry Title">
                                </a>
                            </figure>
                        </div><!-- End .entry-media -->
                        ...
                        <div class="entry-content-wrapper">
                            ...
                            <h2 class="entry-title"><a href="single.html">Praesentium eos officiis nam molestiae facere.</a></h2>


                            <div class="entry-content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec interdum condimentum erat, quis.</p>
                            </div><!-- End .entry-content -->
                        </div><!-- End .entry-content-wrapper -->

                        <footer class="entry-footer clearfix">
                            <span class="entry-cats">
                                <span class="entry-label"><i class="fa fa-tag"></i></span><a href="#">Nature</a>, <a href="#">Design</a>
                            </span><!-- End .entry-tags -->
                            <span class="entry-separator">/</span>
                            <a href="#" class="entry-comments">25 <i class="fa fa-comments"></i></a>
                            <span class="entry-separator">/</span>
                            by <a href="#" class="entry-author">Eon</a>
                    ...
                    <article class="entry entry-box wow zoomIn" data-wow-delay="0.9s">
                        ...
                        <div class="entry-media">
                            ...
                            <div class="entry-audio-container">
                                <audio style="width:100%" preload="none" src="media/audio.mp3"></audio>
                            </div><!-- End .entry-audio-container -->
                        </div><!-- End .entry-media -->

                        <div class="entry-content-wrapper">
                            <span class="entry-date">14<span>Jan</span></span>
                            <span class="entry-format"><i class="fa fa-file-audio-o"></i></span>

                            <h2 class="entry-title"><a href="single.html">Etiam felis erat, suscipit in ante ut, tincidunt tempor justo.</a></h2>


                            <div class="entry-content">
                                <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Quis imperdiet dolor maximus nec. Etiam felis erat, suscipit in.</p>
                            </div><!-- End .entry-content -->
                        </div><!-- End .entry-content-wrapper -->
                    ...
                    <article class="entry entry-box entry-box-blockquote wow zoomIn">
                        ...
                        <div class="entry-content entry-blockquote">
                            <blockquote class="blockquote-icon">
                                <p>Proin a mi posuere, scelerisque arcu et, auctor massa. Nulla vulputate nibh id orci lobortis mattis.</p>
                                <cite>-- Eon Dean Doe</cite>
                            </blockquote>
                        </div><!-- End .entry-content -->

                    </article>

                    <article class="entry entry-box entry-box-blockquote wow zoomIn" data-wow-delay="1.05s">

                        <div class="entry-content entry-blockquote">
                            <blockquote class="blockquote-icon">
                                <p>Ut non sem ac magna aliquam tempor ut at enim. Phasellus iaculis orci risus, nec suscipit turpis imperdiet vel. Mauris non nunc iaculis, laoreet nulla sie.</p>
                                <cite>-- Magic Johnson</cite>
                            </blockquote>
                        </div><!-- End .entry-content -->
            ...
            <div data-bgattach="images/backgrounds/index9/bg3.jpg" class="bg-images">
                <div class="container">
                    <div class="mb70"></div><!-- space -->
                    <h2 class="title-underblock dark text-center mb50">Magic Numbers</h2>
                    <div class="row">
                        <div class="col-md-3 col-xs-6 count-container smaller text-center">
                            <span class="count title-underblock dark" data-from="0" data-to="724" data-speed="3000" data-refresh-interval="50">0</span>
                            <h3>Complated Projects</h3>
                        </div><!-- End .count-container -->

                        <div class="col-md-3 col-xs-6 count-container smaller text-center">
                            <span class="count title-underblock dark" data-from="0" data-to="476" data-speed="3000" data-refresh-interval="50">0</span>
                            <h3>Satisfied Customers</h3>
                        </div><!-- End .count-container -->

                        <div class="mb10 visible-sm visible-xs hidden-xss clearfix"></div><!-- space -->

                        <div class="col-md-3 col-xs-6 count-container smaller text-center">
                            <span class="count title-underblock dark" data-from="0" data-to="89" data-speed="3000" data-refresh-interval="50">0</span>
                            <h3>Winning Awards</h3>
                        </div><!-- End .count-container -->

                        <div class="col-md-3 col-xs-6 count-container smaller text-center">
                            <span class="count title-underblock dark" data-from="0" data-to="1174" data-speed="3000" data-refresh-interval="50">0</span>
                            <h3>Enjoyable Days</h3>
                        </div><!-- End .count-container -->
                    </div><!-- End .row -->
                    <div class="mb20"></div><!--space -->
                </div><!-- End .container -->
            </div><!-- End .fun-facts-container -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="title-border gray title-bg text-center mb40"><span>Checkout Pricing</span></h2>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="pricing-table flat">
                                    ...
                                    <h3>Web Design <span class="label label-popular">Hot</span></h3>
                                    <p class="pricing-desc">

                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet non cupiditate unde vel animi, quae rerum minus obcaecati quis.
                                    </p>
                                    ...
                                    <div class="pricing-action">
                                        <a href="#" class="btn btn-gray no-radius">Order now</a>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="pricing-table flat">
                                    ...
                                    <h3>Social Media <span class="label label-custom">Special</span></h3>
                                    <p class="pricing-desc">
            ...
            <div class="callout callout-vertical larger bg-image no-margin no-border"  data-bgattach="images/backgrounds/index9/bg1.jpg" >
                <div class="mb25"></div><!--space -->
                <h3 class="callout-title">Now you want to purchase Boss Template? We are one click away..</h3>
                <p class="callout-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore harum sit quibusdam earum leo monde neque dignissimos praesentium expedita?</p>
                <div class="callout-action">
                    <a href="#" class="btn btn-white no-radius min-width">More Features!</a>
                    <a href="#" class="btn btn-dark no-radius min-width">Buy Now!</a>
                </div><!-- End .callout-action -->
                <div class="mb15"></div><!--space -->
            </div><!-- End .callout -->
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="widget">
                                <div class="corporate-widget">
                                    <span class="footer-logo">BOSS</span><!-- End .footer-logo -->
                                    ...
                                    <address>
                                        Written by <a href="mailto:puffde@gmail.com">Eon Dean</a>.<br>
                                        Visit us: <a href="http://www.eonythemes.com/">Eonythemes.com</a><br>
                                        Email: <a href="mailto:puffde@gmail.com">puffde@gmail.com</a><br>
                                        Box 26010, Eskisehir - Turkey<br><br>
                                        <abbr title="Templates and Themes">EonyThemes</abbr> &copy;
                                    </address>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="widget">
                                <h4>Categories</h4>
                                <ul class="links">
                                    <li><a href="#"><i class="fa fa-angle-right"></i>Templates (10)</a></li>
                                    <li><a href="#"><i class="fa fa-angle-right"></i>Business (8)</a></li>
                                    <li><a href="#"><i class="fa fa-angle-right"></i>Corporate (7)</a></li>
                                    <li><a href="#"><i class="fa fa-angle-right"></i>Wordpress Themes (5)</a></li>
                                    <li><a href="#"><i class="fa fa-angle-right"></i>Wordpress Plugins (4)</a></li>
                                    <li><a href="#"><i class="fa fa-angle-right"></i>Bootstrap Components (14)</a></li>
                                </ul>
                            </div><!-- End .widget -->
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="widget">
                                <h4>Flickr Feed</h4>
                                <ul class="flickr-widget flickr-widget-two clearfix"></ul>
                            </div><!-- End .widget -->
                            <div class="widget">
                                <h4>Newsletter</h4>
...
<script src="{{asset('assets/frontend/js/jquery.debouncedresize.js')}}"></script>
...
<script src="{{asset('assets/frontend/js/twitter/jquery.tweet.min.js')}}"></script>
