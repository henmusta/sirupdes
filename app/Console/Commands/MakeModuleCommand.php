...
class MakeModuleCommand extends Command {
    ...
    protected function generate() {
        ...
        $modules    = strtolower(Str::plural($module));
        $Model      = $model;
        $targetPath = base_path('Modules/' . $Module);

        //copy folders
        $this->copy(base_path('stubs/boilerplate-module-bs5'), $targetPath);
        ...
        $this->replaceInFile($targetPath . '/Resources/components/alert.blade.php');
        $this->replaceInFile($targetPath . '/Resources/layouts/master.blade.php');
        $this->replaceInFile($targetPath . '/Resources/views/pages/form.blade.php');
        $this->replaceInFile($targetPath . '/Resources/views/pages/show.blade.php');
        $this->replaceInFile($targetPath . '/Resources/views/pages/index.blade.php');
        ...
        $this->rename($targetPath . '/Database/migrations/create_module_table.php', $targetPath . '/Database/migrations/create_' . $modules . '_table.php', 'migration');
    ...
    protected function replaceInFile($path) {
        ...
        $types = [
            ...
            '{module-}' => null,
            '{Module}' => $name,
            '{Modules}' => Str::plural($name),
            '{module}' => strtolower($name),
            '{modules}' => strtolower(Str::plural($name)),
            '{Model}' => $model,
